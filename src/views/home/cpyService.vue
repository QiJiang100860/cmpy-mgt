    ...
    <el-card shadow="never">
      ...
      <el-row :gutter="15">
        <el-col :xl="4" :lg="6" :md="6" :sm="8">
          <el-col class="input-name" :span="7">服务名称</el-col>
          <el-col :span="17">
            <el-input
              placeholder="请输入关键字"
    ...
    <el-card>
      ...
      <div class="table-wrapper">
        <el-table empty-text="暂无数据" :stripe="true" :data="dataOption" v-loading="!dataOption">
          ...
          <el-table-column prop="advertName" label="服务名称"></el-table-column>
      ...
      <div class="dialog-body-content">
        ...
        <el-row :gutter="15">
          ...
          <el-col :span="16" class="content-right">
            <up-load-img ref="imgComponent" v-if="dialogType===1 || dialogType===2" width="192" height="192" resPath="banner"  :type="dialogType===2" :viewUrl="dialogBindData.advertPicUrl" @emitSuccess="handleImgLoad"></up-load-img>
            <img v-view-img v-else :src="dialogBindData.advertPicUrl" width="192" height="192">
          </el-col>
        </el-row>
        ...
        <el-row :gutter="15">
          ...
          <el-col :span="16" class="content-right">
            <el-input
              ...
              size="small"
              placeholder="请输入服务标题"
              v-model="dialogBindData.advertTitle"
            ></el-input>
            <span v-else>{{dialogBindData.advertTitle}}</span>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="15">
          ...
          <el-col :span="16" class="content-right">
            <el-input
              ...
              rows="3"
              resize="none"
              v-model="dialogBindData.linkUrl"
            ></el-input>
...
export default {
  ...
  methods: {
    seachFun() {
      this.$seach
        .submmit(this, common.getAdvertList)
        .then(res => {
    ...
    submmitFun() {
      ...
      isSubmitActive = param.advertName && param.linkUrl && param.advertPicUrl && param.advertTitle && param.advertSubtitle;
      if (isSubmitActive) {
    ...
    handleImgLoad(url){
      this.dialogBindData.advertPicUrl = url
    },
  },
  computed: {
    // 激活重置按钮
