    ...
    <el-card>
      ...
      <div class="table-wrapper">
        <el-table empty-text="暂无数据" :stripe="true" :data="dataOption" v-loading="!dataOption">
          ...
          <el-table-column prop="advertName" label="案例名称"></el-table-column>

          <el-table-column prop="advertSubtitle" label="案例简介"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    submmitFun() {
      ...
      isSubmitActive = param.advertName && param.advertPicUrl && param.advertSubtitle;
      if (isSubmitActive) {
