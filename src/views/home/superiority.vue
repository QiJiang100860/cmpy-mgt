    ...
    <el-card shadow="never">
      ...
      <el-row :gutter="15">
        <el-col :xl="4" :lg="6" :md="6" :sm="8">
          <el-col class="input-name" :span="7">优势名称</el-col>
          <el-col :span="17">
            <el-input
              placeholder="请输入关键字"
    ...
    <el-card>
      ...
      <div class="table-wrapper">
        <el-table empty-text="暂无数据" :stripe="true" :data="dataOption" v-loading="!dataOption">
          ...
          <el-table-column prop="advertName" label="优势名称"></el-table-column>

          <el-table-column prop="linkUrl" label="优势链接"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    submmitFun() {
      ...
      isSubmitActive = param.advertName && param.linkUrl && param.advertPicUrl;
      if (isSubmitActive) {
