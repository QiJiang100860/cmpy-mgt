    ...
    <el-card shadow="never">
      ...
      <el-row :gutter="15">
        <el-col :xl="4" :lg="6" :md="6" :sm="8">
          <el-col class="input-name" :span="7">案例名称</el-col>
          <el-col :span="17">
            <el-input
              placeholder="请输入关键字"
    ...
    <el-card>
      ...
      <div class="table-wrapper">
        <el-table empty-text="暂无数据" :stripe="true" :data="dataOption" v-loading="!dataOption">
          ...
          <el-table-column prop="companyBrief" label="公司简介"></el-table-column>

          <el-table-column prop="companyContent" label="服务内容"></el-table-column>
      ...
      <div class="dialog-body-content">
        ...
        <el-row :gutter="15">
          ...
          <el-col :span="16" class="content-right">
            <up-load-img ref="imgComponent" v-if="dialogType===1 || dialogType===2" width="266" height="175" resPath="banner"  :type="dialogType===2" :viewUrl="dialogBindData.companyPic" @emitSuccess="handleImgLoad"></up-load-img>
            <img v-view-img v-else :src="dialogBindData.companyPic" width="266" height="175">
          </el-col>
        </el-row>
        ...
        <el-row :gutter="15">
          ...
          <el-col :span="16" class="content-right">
            <el-input
              ...
              size="small"
              placeholder="请输入公司名称"
              v-model="dialogBindData.companyName"
            ></el-input>
            <span v-else>{{dialogBindData.companyName}}</span>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="15">
          ...
          <el-col :span="16" class="content-right">
            <el-input
              ...
              placeholder="请输入公司简介"
              resize="none"
              v-model="dialogBindData.companyBrief"
            ></el-input>
            <span v-else>{{dialogBindData.companyBrief}}</span>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="15">
          ...
          <el-col :span="16" class="content-right">
            <el-input
              ...
              placeholder="请输入公司简介"
              resize="none"
              v-model="dialogBindData.companyContent"
            ></el-input>
            <span v-else>{{dialogBindData.companyContent}}</span>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    seachFun() {
      this.$seach
        .submmit(this, service.getCompanyList)
        .then(res => {
    ...
    submmitFun() {
      ...
      let param = {
          companyId:this.dialogBindData.companyId,
          companyName:this.dialogBindData.companyName,
          companyBrief:this.dialogBindData.companyBrief,
          companyContent:this.dialogBindData.companyContent,
          companyPic:this.dialogBindData.companyPic
      };
      let isSubmitActive;
      
      isSubmitActive = param.companyName && param.companyBrief && param.companyContent&& param.companyPic;
      if (isSubmitActive) {
        this.submmitSuccess = true;
        service.addOrEditCompany(param).then(res => {
          if (res.data.code == 1) {
            this.getList(() => {
              this.$message({
    ...
    getList(cb) {
      ...
      service.getCompanyList(param).then(res => {
        // 初始话表格数据
        this.dataOption = res.data.data;
        // 初始化分页数据
        this.rowCount = res.data.rowCount;
    ...
    handleImgLoad(url){
      this.dialogBindData.companyPic = url
    },
  },
  computed: {
    // 激活重置按钮
