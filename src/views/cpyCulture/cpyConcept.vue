    ...
    <el-card shadow="never">
      ...
      <el-row :gutter="15">
        <el-col :xl="4" :lg="6" :md="6" :sm="8">
          <el-col class="input-name" :span="7">理念名称</el-col>
          <el-col :span="17">
            <el-input
              placeholder="请输入关键字"
    ...
    <el-card>
      ...
      <div slot="header" class="clearfix">
        ...
        <div class="btns-wrapper-left">
          ...
          <span><i class="iconfont icon-sousuo"></i>企业理念</span>
        </div>
      </div>
      ...
      <div class="table-wrapper">
        <el-table empty-text="暂无数据" :stripe="true" :data="dataOption" v-loading="!dataOption">
          ...
          <el-table-column prop="advertTitle" label="理念名称"></el-table-column>
          <el-table-column prop="advertContent" label="理念详情"></el-table-column>
        ...
        <el-row :gutter="15">
          ...
          <el-col :span="16" class="content-right">
            <el-input
              ...
              placeholder="请输入案例介绍"
              resize="none"
              v-model="dialogBindData.advertContent"
            ></el-input>
            <span v-else>{{dialogBindData.advertContent}}</span>
          </el-col>
        </el-row>
      </div>
...
export default {
  ...
  methods: {
    ...
    handleImgLoad1(url){
      this.dialogBindData.linkUrl = url
    },
  },
  computed: {
    // 激活重置按钮
